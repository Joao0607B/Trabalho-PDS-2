  ...
  if(permissao == 1) // Admin
  {
    ...
    switch(escolha)
    {
      ...
      case 6:{
        ...
        std::cout << "Nome do sensor atribuido com sucesso" << std::endl;
        sleep(2);
        break;
      }
      case 7:{
      ...
      case 10:{
        ...
        if(escolha_3 == 1)
        {
          ...
          std::cout << "Quarto adicionado com sucesso" << std::endl;
          sleep(2);
          break;
        } 
        ...
        else if(escolha_3 == 2)
        {
          ...
          std::cout << "Cozinha adicionado com sucesso" << std::endl;
          sleep(2);
            break;
        } 
        ...
        else if(escolha_3 == 3)
        {
          ...
          std::cout << "Banheiro adicionado com sucesso" << std::endl;
          sleep(2);
            break;
        }
        ...
        else if(escolha_3 == 4)
        {
          ...
          std::cout << "Garagem adicionado com sucesso" << std::endl;
          sleep(2);
            break;
        } 
        ...
        else if (escolha_3 == 5)
        {
          ...
          std::cout << "Sala adicionado com sucesso" << std::endl;
          sleep(2);
            break;
        } 
