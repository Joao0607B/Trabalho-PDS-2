 ...
 */
static std::map<std::string, usuario> cadastro;
...
public:
  ...
  */
  string get_senha(const string& login) const;
  ...
  */
  int get_nivel(const string& login) const;
  ...
  */
  string get_pergunta(const string& login) const;
  ...
  */
  string get_resposta(const string& login) const;
};
#endif
